let LIMIT = [2512900, 2331200, 1528200, 1409700, 1208900, 676320]; // 1, 2, 3, 4, 5, ..
let CHARGE_TABLE = [
    [33450, 41820, 56060, 69730, 76820, 82370], //1
    [30970, 38720, 51930, 64590, 71060, 76310], //2
    [28590, 35740, 47940, 59460, 65750, 70500], //3
    [27290, 34120, 46300, 58010, 64090, 68860], //4
    [25990, 32490, 44650, 56360, 62460, 67470], //5
    [25990, 32490, 44650, 56360, 56360, 56360], //
];
let VISIT_CHARGE_TABLE = [
    [17450, 25320, 34120, 43430, 50640, 57020, 63530, 70080]
];
