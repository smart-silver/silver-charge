let LIMIT = [2069900, 1869600, 1455800, 1341800, 1151600, 643700];
let CHARGE_TABLE = [
    [32520, 40650, 54490, 67770, 74660, 80060], //1
    [30100, 37630, 50470, 62780, 69160, 74170], //2
    [27790, 34740, 46590, 57960, 63900, 68520], //3
    [25976, 33160, 45000, 56380, 62290, 66930], //4
    [26520, 31580, 43400, 54780, 60710, 65350], //5
    [25260, 31580, 43400, 54780, 54780, 54780], //
];
let VISIT_CHARGE_TABLE = [
    [16940, 24580, 33120, 42160, 49160, 55350, 61670, 68030]
];
